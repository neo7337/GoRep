...
var file_contract_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x73, 0x74, 0x75, 0x62, 0x22, 0x1d, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x39, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65,
	0x12, 0x0d, 0x2e, 0x73, 0x74, 0x75, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a,
	0x0d, 0x2e, 0x73, 0x74, 0x75, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00,
...
var file_contract_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: stub.Message
}
var file_contract_proto_depIdxs = []int32{
	0, // 0: stub.HelloService.consume:input_type -> stub.Message
	0, // 1: stub.HelloService.consume:output_type -> stub.Message
...
type HelloServiceClient interface {
	Consume(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *helloServiceClient) Consume(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/stub.HelloService/consume", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloServiceServer interface {
	Consume(context.Context, *Message) (*Message, error)
}
...
func (*UnimplementedHelloServiceServer) Consume(context.Context, *Message) (*Message, error) {
...
func _HelloService_Consume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServiceServer).Consume(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stub.HelloService/Consume",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Consume(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}

var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "stub.HelloService",
	HandlerType: (*HelloServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "consume",
			Handler:    _HelloService_Consume_Handler,
		},
	},
